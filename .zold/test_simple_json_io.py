...
class MockElement:
    def __init__(self, html_tag, **kwargs):
...
class ArticleElement(MockElement):
    def __init__(self, html_tag, article_number="", article_title="", **kwargs):
...
class SectionElement(MockElement):
    def __init__(self, html_tag, section_number="", section_title="", level=1, **kwargs):
        super().__init__(html_tag, **kwargs)
...
def dump_agreement(path, elements):
...
def test_json_io():
    ...
    print("🧪 Testing JSON I/O functionality...")
    ...
    try:
        ...
        print(f"✅ Serialized to {temp_path}")
        ...
        print("✅ Element attributes preserved")
        ...
        print("✅ Section attributes preserved")
        
        print("🎉 All JSON I/O tests passed!")
        return True
...
def test_cross_reference_regex():
    ...
    print("\n🧪 Testing cross-reference regex patterns...")
    ...
    for text in test_texts:
        ...
        for pattern in section_patterns:
            ...
            for match in matches:
                print(f"  ✅ Found: '{match.group(0)}' using pattern: {pattern}")
                matches_found += 1
    
    print(f"✅ Found {matches_found} cross-reference matches")
    return matches_found > 0


def test_normalized_ids():
    """Test normalized ID generation."""
    print("\n🧪 Testing normalized ID generation...")
    ...
    print("✅ Normalized ID generation working")
...
def main():
    ...
    print("🚀 Running Simple Agreement Processing Tests")
    print("=" * 50)
    ...
    if passed == total:
        ...
        print("⚠️ Some tests failed, but core functionality is demonstrated.")
