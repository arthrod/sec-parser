...
from complete_parser import UniversalEDGARParser, ParsedElement, ElementType, ParseResult
...
def main():
    ...
    logger.info(f"  - 1 combined file (all_complete_semantic_trees.json)")
    logger.info(f"  - 1 processing summary (processing_summary.json)")
