...
from json_io import (
    dump_agreement, load_agreement, linearise, print_outline, 
    rebuild_hierarchy, get_element_stats, validate_agreement_structure,
    get_normalized_id, build_cross_reference_index
)
from cross_reference_extractor import (
    CrossReferenceExtractor, L0DeterministicExtractor, L1RetrievalAssistedExtractor,
    L2LLMValidator, CrossReference, CrossReferenceGraph
)
...
class TestJSONIO:
    ...
    def create_mock_elements(self):
        ...
        from json_io import (
            AgreementTitleElement, ArticleElement, SectionElement, 
    ...
    def test_dump_and_load_agreement(self):
    ...
    def test_validate_agreement_structure(self):
...
class TestCrossReferenceExtraction:
    ...
    def create_test_elements_with_references(self):
        ...
        from json_io import SectionElement, ArticleElement
    ...
    def test_l0_deterministic_extraction(self):
    ...
    def test_l1_retrieval_assisted_extraction(self):
    ...
    def test_l2_llm_validation(self):
    ...
    def test_full_cross_reference_extraction(self):
    ...
    def test_cross_reference_report(self):
...
class TestAgreementParserIntegration:
    ...
    def test_parser_with_json_io(self):
    ...
    def test_parser_with_cross_references(self):
...
class TestRealAgreements:
    ...
    def test_real_agreement_processing(self):
        ...
        print(f"Elements parsed: {validation['total_elements']}")
        print(f"Has title: {validation['has_title']}")
        print(f"Has structure: {validation['has_structure']}")
        print(f"Cross-references found: {report['total_references']}")
...
def run_comprehensive_test():
    ...
    print("🧪 Running Comprehensive Agreement Integration Tests")
    print("=" * 60)
