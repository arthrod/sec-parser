...
def compare_parsing_differences(agreement_num: int) -> dict:
    ...
    print(f"  Analyzing agreement {agreement_num:03d}...")
    ...
    try:
        ...
        # Find differences
        v7_orphan_texts = set(o['text_content'] for o in v7_orphans)
        v8_orphan_texts = set(o['text_content'] for o in v8_orphans)
...
def generate_parsing_differences_report():
    ...
    print(f"Found {len(orphan_difference_cases)} agreements with parsing differences")
...
"""
    ...
    for i, case in enumerate(orphan_difference_cases, 1):
        ...
        print(f"Processing case {i}/{len(orphan_difference_cases)}: Agreement {agreement_num:03d}")
...
def main():
    ...
    print("Extracting actual HTML parsing differences between V7 and V8...")
    print("=" * 80)
    ...
    print(f"\nActual parsing differences report saved to: {output_file}")
    print("Report contains specific HTML snippets that are parsed differently.")
