...
def main():
    ...
    for i, row in enumerate(sampled_df.iter_rows(named=True)):
        ...
        if html_content:
            ...
            print(f"Extracted HTML to {filename}")
        else:
            print(f"No HTML content found in record {i+1}")
    
    print(f"\nExtraction complete!")
    print(f"Successfully extracted HTML from {successful_extractions}/{sample_size} records")
