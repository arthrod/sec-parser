...
def main():
    ...
    print("Extracting HTML examples for V8 regression cases...")
    ...
    regression_cases.sort(key=lambda x: x['increase'], reverse=True)
    
    report_content = generate_html_report(regression_cases)
    
    with open('v8_html_regression_report.md', 'w') as f:
        f.write(report_content)
    
    print(f"HTML regression report saved to: v8_html_regression_report.md")
